...
let exampleFifthhWord = word[21] + word[22] + word[23] + word[24];


console.log(`First Word: "${exampleFirstWord}" Second Word: "${exampleSecondWord}" Third Word: "${exampleThirdWord}" Fourth Word: "${exampleFourthWord}" Fifth Word: "${exampleFifthhWord}"`);
